...
final class Version20191010202110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, user_registration_id INT DEFAULT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, birth_date DATE NOT NULL, nationality VARCHAR(255) NOT NULL, phone_number INT NOT NULL, mail VARCHAR(255) NOT NULL, caces VARCHAR(255) NOT NULL, comment LONGTEXT NOT NULL, INDEX IDX_5D9F75A191E1E3CC (user_registration_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
